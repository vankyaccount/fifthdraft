-- ============================================
-- COMPLETE SCHEMA FOR VPS POSTGRESQL
-- Run this on your Coolify PostgreSQL database
-- ============================================
...
-- ============================================
-- AUTH_USERS TABLE (Custom authentication)
-- ============================================
...
CREATE INDEX IF NOT EXISTS idx_auth_users_verify_token ON public.auth_users(verify_token);
CREATE INDEX IF NOT EXISTS idx_auth_users_reset_token ON public.auth_users(reset_token);
...
-- ============================================
-- GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO fifthdraft;
-- GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO fifthdraft;
-- GRANT EXECUTE ON ALL FUNCTIONS IN SCHEMA public TO fifthdraft;
