      ...
      <section className="py-16 px-4 bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-900 text-white">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto mb-8">
            Transform your meetings and brainstorming sessions into professional deliverables automatically. Get project briefs, reports, documentation, and more—all generated by AI and ready to share.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-10">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
              <FileText className="w-8 h-8 mb-3 mx-auto" />
              <h3 className="font-semibold mb-2">Automated Deliverables</h3>
              <p className="text-sm text-blue-100">
                Project briefs, reports, and documentation generated automatically from your sessions
              </p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
              ...
              <p className="text-sm text-blue-100">
                White-label exports with your branding and custom formatting
              </p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
              ...
              <p className="text-sm text-blue-100">
                Dedicated AI resources and account management for enterprise needs
              </p>
            </div>
          </div>
          <Link
            href="/pricing#raas"
            className="inline-flex items-center gap-2 bg-white text-indigo-900 px-8 py-3 rounded-lg hover:bg-blue-50 transition-colors font-medium"
          >
            Join RAAS Waitlist <ArrowRight className="w-4 h-4" />
          </Link>
        </div>
      </section>
